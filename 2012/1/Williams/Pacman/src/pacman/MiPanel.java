...
public class MiPanel extends JPanel implements Observer, MouseListener {
    ...
    public MiPanel(Grafo gr) {
        ...
        imagenes[2] = Toolkit.getDefaultToolkit().getImage("asustado.png");
        imagenes[0] = Toolkit.getDefaultToolkit().getImage("Muro.JPG");
        imagenes[1] = Toolkit.getDefaultToolkit().getImage("piso.JPG");
        imagenes[3] = Toolkit.getDefaultToolkit().getImage("Vladimir.JPG");
    ...
    public void movida() {
        ...
        JOptionPane.showMessageDialog(null, "Te aplase jajajaj");
    }
